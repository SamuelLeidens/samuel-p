...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="">Apolônio</a>
    ...
    <!-- -------------BANNER------------------ -->
    <section>
        <h1 class="titlle-h1 mt-5"><?php echo "HTML (Linguagem de Marcação de HiperTexto)"; ?></h1>
        <img src="img/img4.jpeg" alt="">
    </section>
    <!-- -------------BANNER------------------ -->
    <!-- -------------CONTEUDO------------------ -->
    <section>
        <h2><?php echo "O que é uma Linguagem de Hipertexto"; ?></h2>
        ...
        <div class="content">
            ...
            <p><?php echo "Mauris nec dcolor in eros commodo tempor. Aenean aliquam molestie leo, vitae iaculis nisl.
            Quem manda na minha terra sou euzis!Todo mundo vê os porris que eu tomo, mas ninguém vê os tombis que eu levo!
            Tá deprimidis, eu conheço uma cachacis que pode alegrar sua vidis."; ?></p>
        </div>
    </section>
